...
def build_model(hp):
	...
	# channel dim for batchnormalization value is the last value in a conv volume
	chanDim = -1

	# first CONV => RELU => POOL layer set
	model.add(Conv2D(
		#hp.integer = total number of filters, evaluate 3 choices 32,64,96
	...
	model.add(Conv2D(
		# hp.integer = next round of filters, 64, 96, 128
