# USAGE
# python main.py --tuner hyperband --plot output/hyperband_plot.png
# python main.py --tuner random --plot output/random_plot.png
# python main.py --tuner bayesian --plot output/bayesian_plot.png

# import the necessary packages
from submodules import config, utils
from submodules.model import build_model
from tensorflow.keras.callbacks import EarlyStopping #shortcircuit if not improving
from tensorflow.keras.datasets import fashion_mnist # our dataset
from tensorflow.keras.utils import to_categorical # one hot encoding of labels
from sklearn.metrics import classification_report # overall accur report
...
# load the Fashion MNIST dataset from disk
